...
class Atri:
	def __init__(self, state: Any):
		...
		self.navSection = state["navSection"]
		self.navbarContainer = state["navbarContainer"]
		self.Logo = state["Logo"]
		self.NavItemContainer = state["NavItemContainer"]
		self.HeroSection = state["HeroSection"]
		self.HeroContainer = state["HeroContainer"]
		self.HeroHeadingContainer = state["HeroHeadingContainer"]
		self.Hero = state["Hero"]
		self.ProjectSection = state["ProjectSection"]
		self.ProjectSectionContainer = state["ProjectSectionContainer"]
		self.ProjectItemsContainer = state["ProjectItemsContainer"]
		self.ProjectItem1 = state["ProjectItem1"]
		self.ProjectPreviewImage = state["ProjectPreviewImage"]
		self.ProjectItemInfo = state["ProjectItemInfo"]
		self.ProjectItemInfoContainer = state["ProjectItemInfoContainer"]
		self.ViewProject1 = state["ViewProject1"]
		self.ProjectItemInfoHeader = state["ProjectItemInfoHeader"]
		...
		self.ProjectPreviewImage3 = state["ProjectPreviewImage3"]
		self.BrowseProjectContainer = state["BrowseProjectContainer"]
		self.AboutMeSection = state["AboutMeSection"]
		self.AboutMeSectionContainer = state["AboutMeSectionContainer"]
		self.Flex21 = state["Flex21"]
		self.Flex22 = state["Flex22"]
		self.Flex23 = state["Flex23"]
		self.Div21 = state["Div21"]
		self.SectionDivider1 = state["SectionDivider1"]
		self.SectionDivider2 = state["SectionDivider2"]
		self.SectionDivider3 = state["SectionDivider3"]
		self.brandName = state["brandName"]
		...
		self.HeroBodyContainer = state["HeroBodyContainer"]
		self.ProjectsHeading = state["ProjectsHeading"]
		self.Image1 = state["Image1"]
		self.LinkViewProject1 = state["LinkViewProject1"]
		self.ProjectInfoName = state["ProjectInfoName"]
		self.ProjectInfoHeader = state["ProjectInfoHeader"]
		self.ProjectInfoDesc = state["ProjectInfoDesc"]
		self.TextBox10 = state["TextBox10"]
		self.TextBox11 = state["TextBox11"]
		self.TextBox12 = state["TextBox12"]
		self.LinkViewProject2 = state["LinkViewProject2"]
		self.Image5 = state["Image5"]
		self.TextBox13 = state["TextBox13"]
		self.TextBox14 = state["TextBox14"]
		self.TextBox15 = state["TextBox15"]
		self.LinkViewProject3 = state["LinkViewProject3"]
		self.Image4 = state["Image4"]
		self.Image6 = state["Image6"]
		self.BtnBrowsePortfolio = state["BtnBrowsePortfolio"]
	...
	@property
	def navSection(self):
		self._getter_access_tracker["navSection"] = {}
		return self._navSection
	@navSection.setter
	def navSection(self, new_state):
		self._setter_access_tracker["navSection"] = {}
		global default_state
		self._navSection = Div(new_state, default_state["navSection"])
	...
	@property
	def NavItemContainer(self):
		self._getter_access_tracker["NavItemContainer"] = {}
		return self._NavItemContainer
	@NavItemContainer.setter
	def NavItemContainer(self, new_state):
		self._setter_access_tracker["NavItemContainer"] = {}
		global default_state
		self._NavItemContainer = Flex(new_state, default_state["NavItemContainer"])
	...
	@property
	def HeroContainer(self):
		self._getter_access_tracker["HeroContainer"] = {}
		return self._HeroContainer
	@HeroContainer.setter
	def HeroContainer(self, new_state):
		self._setter_access_tracker["HeroContainer"] = {}
		global default_state
		self._HeroContainer = Flex(new_state, default_state["HeroContainer"])

	@property
	def HeroHeadingContainer(self):
		self._getter_access_tracker["HeroHeadingContainer"] = {}
		return self._HeroHeadingContainer
	@HeroHeadingContainer.setter
	def HeroHeadingContainer(self, new_state):
		self._setter_access_tracker["HeroHeadingContainer"] = {}
		global default_state
		self._HeroHeadingContainer = Div(new_state, default_state["HeroHeadingContainer"])
	...
	def Hero(self, new_state):
		...
		global default_state
		self._Hero = Div(new_state, default_state["Hero"])
	...
	def ProjectSection(self, new_state):
		...
		global default_state
		self._ProjectSection = Div(new_state, default_state["ProjectSection"])

	@property
	def ProjectSectionContainer(self):
		self._getter_access_tracker["ProjectSectionContainer"] = {}
		return self._ProjectSectionContainer
	@ProjectSectionContainer.setter
	def ProjectSectionContainer(self, new_state):
		self._setter_access_tracker["ProjectSectionContainer"] = {}
		global default_state
		self._ProjectSectionContainer = Div(new_state, default_state["ProjectSectionContainer"])

	@property
	def ProjectItemsContainer(self):
		self._getter_access_tracker["ProjectItemsContainer"] = {}
		return self._ProjectItemsContainer
	@ProjectItemsContainer.setter
	def ProjectItemsContainer(self, new_state):
		self._setter_access_tracker["ProjectItemsContainer"] = {}
		global default_state
		self._ProjectItemsContainer = Flex(new_state, default_state["ProjectItemsContainer"])

	@property
	def ProjectItem1(self):
		self._getter_access_tracker["ProjectItem1"] = {}
		return self._ProjectItem1
	@ProjectItem1.setter
	def ProjectItem1(self, new_state):
		self._setter_access_tracker["ProjectItem1"] = {}
		global default_state
		self._ProjectItem1 = Flex(new_state, default_state["ProjectItem1"])

	@property
	def ProjectPreviewImage(self):
		self._getter_access_tracker["ProjectPreviewImage"] = {}
		return self._ProjectPreviewImage
	@ProjectPreviewImage.setter
	def ProjectPreviewImage(self, new_state):
		self._setter_access_tracker["ProjectPreviewImage"] = {}
		global default_state
		self._ProjectPreviewImage = Div(new_state, default_state["ProjectPreviewImage"])

	@property
	def ProjectItemInfo(self):
		self._getter_access_tracker["ProjectItemInfo"] = {}
		return self._ProjectItemInfo
	@ProjectItemInfo.setter
	def ProjectItemInfo(self, new_state):
		self._setter_access_tracker["ProjectItemInfo"] = {}
		global default_state
		self._ProjectItemInfo = Flex(new_state, default_state["ProjectItemInfo"])

	@property
	def ProjectItemInfoContainer(self):
		self._getter_access_tracker["ProjectItemInfoContainer"] = {}
		return self._ProjectItemInfoContainer
	@ProjectItemInfoContainer.setter
	def ProjectItemInfoContainer(self, new_state):
		self._setter_access_tracker["ProjectItemInfoContainer"] = {}
		global default_state
		self._ProjectItemInfoContainer = Flex(new_state, default_state["ProjectItemInfoContainer"])

	@property
	def ViewProject1(self):
		self._getter_access_tracker["ViewProject1"] = {}
		return self._ViewProject1
	@ViewProject1.setter
	def ViewProject1(self, new_state):
		self._setter_access_tracker["ViewProject1"] = {}
		global default_state
		self._ViewProject1 = Div(new_state, default_state["ViewProject1"])

	@property
	def ProjectItemInfoHeader(self):
		self._getter_access_tracker["ProjectItemInfoHeader"] = {}
		return self._ProjectItemInfoHeader
	@ProjectItemInfoHeader.setter
	def ProjectItemInfoHeader(self, new_state):
		self._setter_access_tracker["ProjectItemInfoHeader"] = {}
		global default_state
		self._ProjectItemInfoHeader = Flex(new_state, default_state["ProjectItemInfoHeader"])
	...
	@property
	def ProjectPreviewImage3(self):
		self._getter_access_tracker["ProjectPreviewImage3"] = {}
		return self._ProjectPreviewImage3
	@ProjectPreviewImage3.setter
	def ProjectPreviewImage3(self, new_state):
		self._setter_access_tracker["ProjectPreviewImage3"] = {}
		global default_state
		self._ProjectPreviewImage3 = Div(new_state, default_state["ProjectPreviewImage3"])

	@property
	def BrowseProjectContainer(self):
		self._getter_access_tracker["BrowseProjectContainer"] = {}
		return self._BrowseProjectContainer
	@BrowseProjectContainer.setter
	def BrowseProjectContainer(self, new_state):
		self._setter_access_tracker["BrowseProjectContainer"] = {}
		global default_state
		self._BrowseProjectContainer = Flex(new_state, default_state["BrowseProjectContainer"])

	@property
	def AboutMeSection(self):
		self._getter_access_tracker["AboutMeSection"] = {}
		return self._AboutMeSection
	@AboutMeSection.setter
	def AboutMeSection(self, new_state):
		self._setter_access_tracker["AboutMeSection"] = {}
		global default_state
		self._AboutMeSection = Div(new_state, default_state["AboutMeSection"])

	@property
	def AboutMeSectionContainer(self):
		self._getter_access_tracker["AboutMeSectionContainer"] = {}
		return self._AboutMeSectionContainer
	@AboutMeSectionContainer.setter
	def AboutMeSectionContainer(self, new_state):
		self._setter_access_tracker["AboutMeSectionContainer"] = {}
		global default_state
		self._AboutMeSectionContainer = Flex(new_state, default_state["AboutMeSectionContainer"])
	...
	@property
	def SectionDivider1(self):
		self._getter_access_tracker["SectionDivider1"] = {}
		return self._SectionDivider1
	@SectionDivider1.setter
	def SectionDivider1(self, new_state):
		self._setter_access_tracker["SectionDivider1"] = {}
		global default_state
		self._SectionDivider1 = Div(new_state, default_state["SectionDivider1"])

	@property
	def SectionDivider2(self):
		self._getter_access_tracker["SectionDivider2"] = {}
		return self._SectionDivider2
	@SectionDivider2.setter
	def SectionDivider2(self, new_state):
		self._setter_access_tracker["SectionDivider2"] = {}
		global default_state
		self._SectionDivider2 = Div(new_state, default_state["SectionDivider2"])

	@property
	def SectionDivider3(self):
		self._getter_access_tracker["SectionDivider3"] = {}
		return self._SectionDivider3
	@SectionDivider3.setter
	def SectionDivider3(self, new_state):
		self._setter_access_tracker["SectionDivider3"] = {}
		global default_state
		self._SectionDivider3 = Div(new_state, default_state["SectionDivider3"])

	@property
	def brandName(self):
		self._getter_access_tracker["brandName"] = {}
		return self._brandName
	@brandName.setter
	def brandName(self, new_state):
		self._setter_access_tracker["brandName"] = {}
		global default_state
		self._brandName = TextBox(new_state, default_state["brandName"])
	...
	@property
	def HeroBodyContainer(self):
		self._getter_access_tracker["HeroBodyContainer"] = {}
		return self._HeroBodyContainer
	@HeroBodyContainer.setter
	def HeroBodyContainer(self, new_state):
		self._setter_access_tracker["HeroBodyContainer"] = {}
		global default_state
		self._HeroBodyContainer = TextBox(new_state, default_state["HeroBodyContainer"])
	...
	@property
	def LinkViewProject1(self):
		self._getter_access_tracker["LinkViewProject1"] = {}
		return self._LinkViewProject1
	@LinkViewProject1.setter
	def LinkViewProject1(self, new_state):
		self._setter_access_tracker["LinkViewProject1"] = {}
		global default_state
		self._LinkViewProject1 = Link(new_state, default_state["LinkViewProject1"])

	@property
	def ProjectInfoName(self):
		self._getter_access_tracker["ProjectInfoName"] = {}
		return self._ProjectInfoName
	@ProjectInfoName.setter
	def ProjectInfoName(self, new_state):
		self._setter_access_tracker["ProjectInfoName"] = {}
		global default_state
		self._ProjectInfoName = TextBox(new_state, default_state["ProjectInfoName"])

	@property
	def ProjectInfoHeader(self):
		self._getter_access_tracker["ProjectInfoHeader"] = {}
		return self._ProjectInfoHeader
	@ProjectInfoHeader.setter
	def ProjectInfoHeader(self, new_state):
		self._setter_access_tracker["ProjectInfoHeader"] = {}
		global default_state
		self._ProjectInfoHeader = TextBox(new_state, default_state["ProjectInfoHeader"])

	@property
	def ProjectInfoDesc(self):
		self._getter_access_tracker["ProjectInfoDesc"] = {}
		return self._ProjectInfoDesc
	@ProjectInfoDesc.setter
	def ProjectInfoDesc(self, new_state):
		self._setter_access_tracker["ProjectInfoDesc"] = {}
		global default_state
		self._ProjectInfoDesc = TextBox(new_state, default_state["ProjectInfoDesc"])
	...
	@property
	def LinkViewProject2(self):
		self._getter_access_tracker["LinkViewProject2"] = {}
		return self._LinkViewProject2
	@LinkViewProject2.setter
	def LinkViewProject2(self, new_state):
		self._setter_access_tracker["LinkViewProject2"] = {}
		global default_state
		self._LinkViewProject2 = Link(new_state, default_state["LinkViewProject2"])
	...
	@property
	def LinkViewProject3(self):
		self._getter_access_tracker["LinkViewProject3"] = {}
		return self._LinkViewProject3
	@LinkViewProject3.setter
	def LinkViewProject3(self, new_state):
		self._setter_access_tracker["LinkViewProject3"] = {}
		global default_state
		self._LinkViewProject3 = Link(new_state, default_state["LinkViewProject3"])
	...
	@property
	def BtnBrowsePortfolio(self):
		self._getter_access_tracker["BtnBrowsePortfolio"] = {}
		return self._BtnBrowsePortfolio
	@BtnBrowsePortfolio.setter
	def BtnBrowsePortfolio(self, new_state):
		self._setter_access_tracker["BtnBrowsePortfolio"] = {}
		global default_state
		self._BtnBrowsePortfolio = TextBox(new_state, default_state["BtnBrowsePortfolio"])
	...
	def _to_json_fields(self):
		return {
			"navSection": self._navSection,
			"navbarContainer": self._navbarContainer,
			"Logo": self._Logo,
			"NavItemContainer": self._NavItemContainer,
			"HeroSection": self._HeroSection,
			"HeroContainer": self._HeroContainer,
			"HeroHeadingContainer": self._HeroHeadingContainer,
			"Hero": self._Hero,
			"ProjectSection": self._ProjectSection,
			"ProjectSectionContainer": self._ProjectSectionContainer,
			"ProjectItemsContainer": self._ProjectItemsContainer,
			"ProjectItem1": self._ProjectItem1,
			"ProjectPreviewImage": self._ProjectPreviewImage,
			"ProjectItemInfo": self._ProjectItemInfo,
			"ProjectItemInfoContainer": self._ProjectItemInfoContainer,
			"ViewProject1": self._ViewProject1,
			"ProjectItemInfoHeader": self._ProjectItemInfoHeader,
			"Flex14": self._Flex14,
			"Flex13": self._Flex13,
			"Flex12": self._Flex12,
			"Flex11": self._Flex11,
			...
			"Flex15": self._Flex15,
			"Div17": self._Div17,
			"ProjectPreviewImage3": self._ProjectPreviewImage3,
			"BrowseProjectContainer": self._BrowseProjectContainer,
			"AboutMeSection": self._AboutMeSection,
			"AboutMeSectionContainer": self._AboutMeSectionContainer,
			"Flex21": self._Flex21,
			"Flex22": self._Flex22,
			"Flex23": self._Flex23,
			"Div21": self._Div21,
			"SectionDivider1": self._SectionDivider1,
			"SectionDivider2": self._SectionDivider2,
			"SectionDivider3": self._SectionDivider3,
			...
			"HeroBodyContainer": self._HeroBodyContainer,
			"ProjectsHeading": self._ProjectsHeading,
			"Image1": self._Image1,
			"LinkViewProject1": self._LinkViewProject1,
			"ProjectInfoName": self._ProjectInfoName,
			"ProjectInfoHeader": self._ProjectInfoHeader,
			"ProjectInfoDesc": self._ProjectInfoDesc,
			"TextBox10": self._TextBox10,
			"TextBox11": self._TextBox11,
			"TextBox12": self._TextBox12,
			"LinkViewProject2": self._LinkViewProject2,
			"Image5": self._Image5,
			"TextBox13": self._TextBox13,
			"TextBox14": self._TextBox14,
			"TextBox15": self._TextBox15,
			"LinkViewProject3": self._LinkViewProject3,
			"Image4": self._Image4,
			"Image6": self._Image6,
			"BtnBrowsePortfolio": self._BtnBrowsePortfolio,
